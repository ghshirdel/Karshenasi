...
Public Class Mali_frm
    'Private WithEvents txtdg As New DataGridViewTextBoxEditingControl
    Dim Kid As Integer
    ...
    Private Sub Mali_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Mali_frm_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
    ...
    Private Sub Set_ReadOnly_Column_datagrid()
        Pay_datagrid.CurrentRow.Cells(2).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(3).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(4).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(5).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(6).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(7).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(8).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(9).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(10).ReadOnly = False
        Pay_datagrid.CurrentRow.Cells(11).ReadOnly = False
    End Sub
    Private Sub Set_Editable_column_datagrid()
        Pay_datagrid.CurrentRow.Cells(2).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(3).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(4).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(5).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(6).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(7).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(8).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(9).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(10).ReadOnly = True
        Pay_datagrid.CurrentRow.Cells(11).ReadOnly = True
    End Sub

    Public Function Cama_Number1(ByVal StrNumber As String)
        Dim Str As String = ""
        If (StrNumber <> "") Then
            If (StrNumber.Length > 3) Then
                SendKeys.Send("{end}")
                Str = Format$(StrNumber.Replace(",", ""))
            Else
                Str = StrNumber
            End If
        End If
        Cama_Number1 = Format$(Val(Str), "###,###,###")

    End Function

    Private Sub Date_Fa_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Dim pt As New PersianToolS.PersinToolsClass
        'If Select_Pay_flag = True Then
        'Pay_datagrid.CurrentRow.Cells(5).Value = pt.DateToPersian(Date_Fa.SelectedDateTime).ShortDate
        ''Date_Panel.Visible = False
        'End If
    End Sub

    Private Sub Date_Fa_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub Mali_frm_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Close()
        End If
    End Sub
    ...
    Private Sub Pay_datagrid_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Pay_datagrid.CellContentClick
    ...
    Private Sub Pay_datagrid_CellValueChanged(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Pay_datagrid.CellValueChanged
    ...
    Private Sub TextBox1_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.Leave
        'If TextBox1.Text <> "" Then
        'Pay_datagrid.CurrentRow.Cells(6).Value = CInt(TextBox1.Text)
        'Obj(6) = CInt(TextBox1.Text)
        'TextBox1.Visible = False
        'Pay_datagrid.Focus()
        'End If
    End Sub
    ...
    Private Sub Pay_datagrid_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles Pay_datagrid.CellMouseClick
        ...
        If e.ColumnIndex = 5 Then
            ...
            Date_Obj(2) = Pay_datagrid.CurrentRow.Cells(5).Value.ToString
    ...
    Private Sub Mali_frm_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        If Return_Flag = True Then
            Pay_datagrid.CurrentRow.Cells(5).Value = Date_return
            Return_Flag = False
        End If
    End Sub
End Class